...
function Description() {
  return (
    <motion.div
      ...
      variants={div}
    >
      <motion.div className={classes.single_description} variants={item}>
        <svg
        ...
        >
          ...
          >
            ...
            <path d="M15 8h-3m-3 8h2m0 0h1a2 2 0 0 0 2-2v0a2 2 0 0 0-2-2h-2a2 2 0 0 1-2-2v0a2 2 0 0 1 2-2h1m0 8v2m0-10V6" />
          </g>
        </svg>
